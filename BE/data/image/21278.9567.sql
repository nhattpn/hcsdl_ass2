...
FROM 'E:\Downloads\data sample\users.csv'
DELIMITER ',' 
CSV HEADER;
...
FROM 'E:\Downloads\data sample\category.csv'
DELIMITER ',' 
CSV HEADER;
...
COPY product (product_id, pname, brand, description, price, quantity, create_time, cate_id, sold, rating)
FROM 'E:\Downloads\product.csv'
DELIMITER ',' 
CSV HEADER;
...
FROM 'E:\Downloads\data sample\image.csv'
DELIMITER ',' 
CSV HEADER;
...
COPY promotion (promotion_id, name, quantity, description,starttime, endtime, minspent,discount_type, apply_range, apply_id, value, percentage, max_amount)
FROM 'E:\Downloads\data sample\promotion.csv'
DELIMITER ',' 
CSV HEADER;
